...
B=Path('D:/CodexWorkspaces/mathematics-atlas');source=B/'novelty-multipartite-work/raw-02.json';logger=B/'project/experiments/kemeny-three-part-proof/run_logged.py'
def sha(p):return hashlib.sha256(p.read_bytes()).hexdigest()
assert sha(logger)=='b6f4c329387705b2adf67f7dd3f806bbcd0a5906d476f5214fe8278d5ea5bfa6'
