...
def main() -> int:
    ...
    manifest = {
        "schema_version": "boolean-rank-independent-checker-freeze-v2",
        ...
        "supersedes": {
            ...
            "reason": "The first data checker compared raw Markdown substrings and falsely failed text containing backticks or a line break. V2 normalizes backticks and whitespace only; all semantic obligations and inputs are unchanged.",
