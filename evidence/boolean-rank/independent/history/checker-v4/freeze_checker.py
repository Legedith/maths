...
def main() -> int:
    ...
    manifest = {
        "schema_version": "boolean-rank-independent-checker-freeze-v4",
        ...
        "supersedes": {
            "path": "checker-freeze-v3.json",
            "sha256": "e2421ccc5cf00f890886cd8fe9325665a93e7c69ba459f39cf684a02997fc876",
            "reason": "ESM-loading React did not resolve the react/jsx-runtime interop failure. V4 transpiles TSX to classic createElement calls under a checker-only private React import; assertions and implementation inputs remain unchanged.",
            "retained_failed_runs": ["logs/runtime/attempt-independent-runtime-01.json", "logs/runtime/attempt-independent-runtime-02.json"],
        },
