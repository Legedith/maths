...
def main() -> None:
    ...
    output = {
        "schema_version": "boolean-rank-release-delta-checker-freeze-v2",
        ...
        "supersedes": {
            "path": "release-delta-checker-freeze-v1.json",
            "sha256": "c1248aa8ad64a2456db80c63c6afb676ab1ac61aa27e0a9f04bcac66c06370db",
            "retained_failed_attempt": "logs/release-delta/attempt-release-delta-01.json",
            "reason": "V1 matched one scope sentence with a literal line break. V2 normalizes whitespace before checking the identical sentence; all product assertions and inputs are unchanged.",
        },
    }
