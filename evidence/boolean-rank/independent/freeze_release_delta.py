...
def main() -> None:
    ...
    output = {
        "schema_version": "boolean-rank-release-delta-checker-freeze-v3",
        ...
        "supersedes": {
            "path": "release-delta-checker-freeze-v2.json",
            "sha256": "7cf95ec7d410835b0d8fe868ea6ccd2312caa9475d1cf1d786d66bea5afc9adc",
            "retained_failed_attempts": [
                "logs/release-delta/attempt-release-delta-01.json",
                "logs/release-delta/attempt-release-delta-02.json"
            ],
            "reason": "V1 required a literal line break and V2 expected wording with `not`; the actual scoped sentence uses `neither ... treated`. V3 normalizes whitespace and checks both exact semantic clauses. All product assertions and inputs are unchanged.",
        },
    }
