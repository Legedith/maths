...
def main() -> int:
    ...
    manifest = {
        "schema_version": "boolean-rank-independent-checker-freeze-v6",
        ...
        "supersedes": {
            "path": "checker-freeze-v5.json",
            "sha256": "aed8bec3b58433c3a3da3e3c0f7ee307a41264a94c5729d80a0189ca6bd64fd7",
            "reason": "The V5 HTTP assertion searched raw streamed HTML for adjacent dynamic text, but React inserts empty comment separators. V6 removes only those separators before checking the same scope and count text; all product assertions and inputs remain unchanged.",
            "retained_failed_runs": ["logs/runtime/attempt-independent-runtime-01.json", "logs/runtime/attempt-independent-runtime-02.json", "logs/runtime/attempt-independent-runtime-03.json", "logs/runtime/attempt-independent-runtime-04.json"],
        },
