...
pending-review wording; the later review records its admission. The new
product integration still requires its own independent final review before
publication. The [projection](../evidence/boolean-rank/integration-projection.json)
